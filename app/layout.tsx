      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t;try{t=localStorage.getItem("omp-theme")}catch(e){}var d=matchMedia("(prefers-color-scheme: dark)").matches;var dt={"dark":1,"omp":1,"dracula":1,"harbor":1,"one-dark-pro":1,"rose-pine":1,"catppuccin-mocha":1,"gruvbox-dark":1,"nord":1,"tokyo-night":1,"oled":1,"pine":1,"navy":1,"codex":1,"aurora-flow":1,"dawn-flow":1,"cosmic-flow":1,"ocean-flow":1,"sakura-flow":1,"bamboo-flow":1};var lt={"light":1,"one-light":1,"catppuccin-latte":1,"rose-pine-dawn":1,"oatmeal":1,"matcha":1,"sepia":1};if(t==="custom"){document.documentElement.setAttribute("data-theme","custom");try{var c=JSON.parse(localStorage.getItem("omp-custom-theme")||"{}");if(c.isDark)document.documentElement.classList.add("dark")}catch(e2){}var m=document.querySelector('meta[name="theme-color"]'),bg=getComputedStyle(document.documentElement).getPropertyValue("--bg").trim();if(m&&bg)m.setAttribute("content",bg);return}var res=t==="system"?(d?"dark":"light"):(!t?"omp":t);if(!dt[res]&&!lt[res]&&res!=="omp")res="omp";var dark=!!dt[res]&&res!=="omp";if(dark)document.documentElement.classList.add("dark");if(res==="omp"){document.documentElement.classList.add("omp")}else{document.documentElement.classList.add("theme-"+res)}document.documentElement.setAttribute("data-theme",res);if(String(res).slice(-5)==="-flow")document.documentElement.classList.add("theme-flow-active");var meta=document.querySelector('meta[name="theme-color"]'),color=getComputedStyle(document.documentElement).getPropertyValue("--bg").trim();if(meta&&color)meta.setAttribute("content",color);}catch(e){}})();`,
          }}
        />
        <script
          dangerouslySetInnerHTML={{
