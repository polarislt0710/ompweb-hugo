...
test("resolves sandbox: and computer: agent file schemes", async () => {
  const { resolveLocalFileHref } = await loadSubject();

  assert.equal(
    resolveLocalFileHref(
      "sandbox:/Users/hugo/Documents/Workspace/AI%20editing%20V2/cantonese-tts-test.mp3",
      "/Users/hugo/Documents/Workspace/AI editing V2",
    ),
    "/Users/hugo/Documents/Workspace/AI editing V2/cantonese-tts-test.mp3",
  );
  assert.equal(
    resolveLocalFileHref(
      "sandbox:/var/folders/g7/tmp/omp-image-157b908133f3d2db.webp",
      "/Users/hugo/Documents/Workspace/AI editing V2",
    ),
    "/var/folders/g7/tmp/omp-image-157b908133f3d2db.webp",
  );
  assert.equal(
    resolveLocalFileHref("computer:/tmp/out.mp3", "/Users/hugo/project"),
    "/tmp/out.mp3",
  );
});
